...
max_curve = model_CNR(x_range, params[0] + std_devs[0], params[1] + std_devs[1])
min_curve = model_CNR(x_range, params[0] - std_devs[0], params[1] - std_devs[1])

plt.errorbar(n_images_values, cnr_values, yerr=cnr_err, fmt='o', color=palette[3],
            elinewidth=0.8, capsize=3, label='Données CNR')
...
plt.fill_between(x_range, max_curve, min_curve, color='gray', alpha=0.2,
